...
- 覆盖：22 个 `synthesis` 页面，其中 21 个主题综合页已补齐 `联网补充`
- 页面更新：新增 1 个语料映射页，原有 21 个主题综合页保持联网事实补强状态
...
## Segmentation Robustness Synthesis (2026-04-10)

- Added 6 synthesis pages for theme-level navigation.
- [[synthesis/Segmentation Adversarial Attack Methods 2019-2026]]
- [[synthesis/Robust Training Strategies for Semantic Segmentation]]
- [[synthesis/Certified and Verified Robust Segmentation]]
- [[synthesis/Patch Attack and Defense in Segmentation]]
- [[synthesis/LiDAR Semantic Segmentation Security Landscape]]
- [[synthesis/Reliability and Benchmarking for Robust Segmentation]]
- [[synthesis/Segmentation Robustness Batch Reading Matrix 2019-2026]]
