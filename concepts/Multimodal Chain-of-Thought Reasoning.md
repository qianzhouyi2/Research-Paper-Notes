...
- ????????????????????????????????
- ?????? ﻿--- title: Multimodal Chain-of-Thought Reasoning category: concept tags: - concept - multimodal - reasoning - cot sources: - notes/Multimodal Chain-of-Thought Reasoning in Language Models.md created: 2026-04-08 updated: 2026-04-08 summary: 多模态 CoT 通过引入视觉证据链改善...
- ????????????
- ??????????? URL???????????????^[ambiguous]
- ????????????arXiv / DOI / ???????????????????
- ?????????????????????
