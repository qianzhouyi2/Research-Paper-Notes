...
- ????????????????????????????????
- ?????? ﻿--- title: GFlowNet Posterior Sampling for Text Generation category: concept tags: - concept - llm - sampling - inference sources: - notes/Amortizing intractable inference in large language models.md created: 2026-04-08 updated: 2026-04-08 summary: 利用 GFlowNe...
- ????????????
- ??????????? URL???????????????^[ambiguous]
- ????????????arXiv / DOI / ???????????????????
- ?????????????????????
