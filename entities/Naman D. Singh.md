...
created: 2026-04-16
updated: 2026-04-16
summary: "Naman D. Singh：当前语义分割鲁棒性子语料中的作者实体卡，关联 SEA 与 PIR-AT 这篇核心论文。"
provenance:
  extracted: 0.82
  inferred: 0.15
  ambiguous: 0.03
...
- 在当前语义分割鲁棒性子语料中出现于 1 篇已核验论文。
- 主要语境：鲁棒评测、对抗训练与 robust initialization。^[inferred]
